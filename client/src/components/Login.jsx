...
const Login = () => {
  ...
  return (
    ...
    viewport={{once:true}}
        ...
        <p className='text-sm'>Welcome back! Please login in to continue</p>


{state!= 'Login' &&
        <div className='norder px-6 py-2 flex item-center gap-2 rounded-full mt-5'>
         ...
         <div className='norder px-6 py-2 flex item-center gap-2 rounded-full mt-4'>
            <img src= {assets.email_icon_icon}/>
